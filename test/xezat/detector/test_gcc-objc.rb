...
class GccObjcTest < Test::Unit::TestCase
  ...
  def test_get_components
    ...
    root_ok = {:S => File.expand_path(File.join(File.dirname(__FILE__), 'fixture', 'gcc-objc', 'ok'))}
    assert_equal(['gcc-objc', 'gcc-core', 'binutils'], detector.get_components(root_ok))
    root_ng = {:S => File.expand_path(File.join(File.dirname(__FILE__), 'fixture', 'gcc-objc', 'ng'))}
